...
Come offerta speciale solo per ospizi abituali (o i loro amici), prenotando **almeno due notti**, non paghi la tassa di pulizia di € 27. Per trarne vantaggio, **segui le istruzioni seguenti**.
...
5. Comunicare il vostro arrivo con un giorno di anticipo con una stima approssimativa dell'orario del vostro arrivo. **Ricorda che tutte le comunicazioni avvengono su WhatsApp. Dal primo all'ultimo messaggio**.
